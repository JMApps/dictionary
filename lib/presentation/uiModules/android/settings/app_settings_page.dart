            ...
            slivers: [
                      ...
                      showTimePicker(
                        ...
                        initialTime: TimeOfDay.fromDateTime(
                          DateTime(
                            ...
                            12,
                            31,
                            settings.getNotificationHours,
                            settings.getNotificationMinutes,
                          ),
                        ),
                        ...
                        (TimeOfDay? time) {
                          if (time != null) {
                            settings.changeNotificationTime = Duration(
                              hours: time.hour,
                              minutes: time.minute,
                            );
                  ...
                  trailing: Switch(
                    ...
                    onChanged: (bool value) {
                      ...
                      if (value) {
                        ...
                        localNotice.cancelNotificationWithId(
                          LocalNoticeService.dailyNotificationID,
                        );
                      }
                    },
                  ),
              ...
              SliverToBoxAdapter(
                child: ListTile(
                  onTap: () {
                    _launchUrl(
                      link: 'https://play.google.com/store/apps/dev?id=6670628331565360591',
                    );
                  },
                  title: const Text(
                    AppStrings.applications,
