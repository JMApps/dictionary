...
class WordDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DictionaryEntity>(
      future: Provider.of<DefaultDictionaryState>(
        context,
        listen: false,
      ).getWordById(wordNumber: wordNumber),
                          ...
                          children: [
                            ...
                            FutureBuilder<List<DictionaryEntity>>(
                              ...
                              builder: (context, wordRootsSnapshot) {
                                ...
                                if (wordRootsSnapshot.hasData &&
                                    wordRootsSnapshot.data!.isNotEmpty) {
