...
class FavoriteWordDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<FavoriteDictionaryEntity>(
      future: Provider.of<FavoriteWordsState>(
        context,
      ).fetchFavoriteWordById(favoriteWordId: wordNumber),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FutureBuilder<List<DictionaryEntity>>(
                        future: Provider.of<DefaultDictionaryState>(context, listen: false).getWordsByRoot(wordRoot: snapshot.data!.root, excludedId: snapshot.data!.wordNumber),
