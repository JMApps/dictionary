...
class _SearchCollectionAddFutureState extends State<SearchCollectionAddFuture> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color itemOddColor = appColors.primary.withAlpha(10);
    final Color itemEvenColor = appColors.primary.withAlpha(25);
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        if (snapshot.hasData) {
          ...
          _recentCollections = widget.query.isEmpty
              ...
              : _collections
                    .where(
                      (element) => element.title.toLowerCase().contains(widget.query.toLowerCase()),
                    )
                    .toList();
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      onTap: () async {
                        ...
                        await Provider.of<FavoriteWordsState>(
                          context,
                          listen: false,
                        ).addFavoriteWord(model: favoriteWordModel);
                      },
                      title: Text(
                      ...
                      trailing: FutureBuilder<int>(
                        future: Provider.of<CollectionsState>(
                          context,
                          listen: false,
                        ).getWordCount(collectionId: collectionModel.id),
