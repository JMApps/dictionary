                ...
                onPressed: () {
                  if (_collectionController.text.trim().isNotEmpty) {
                    final Map<String, dynamic> mapCollection = {
                      DBValues.dbId: widget.collectionModel.id,
                      DBValues.dbWordsCount: _collectionController.text.trim(),
                      DBValues.dbColor: colorState.colorIndex,
                    };
                    if (!widget.collectionModel.equals(
                      CollectionEntity(
                      ...
                      Provider.of<CollectionsState>(
                        context,
                        listen: false,
                      ).changeCollection(mapCollection: mapCollection);
                    } else {
                      Navigator.pop(context);
                    }
                  }
