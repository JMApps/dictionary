          ...
          return CupertinoPageScaffold(
            ...
            navigationBar: CupertinoNavigationBar(
              ...
              trailing: CupertinoButton(
                ...
                onPressed: () {
                  cardModeState.cardMode = !cardModeState.cardMode;
                },
                child: const Icon(
            ...
            child: FutureBuilder<List<FavoriteDictionaryEntity>>(
              future: Provider.of<FavoriteWordsState>(
                context,
                listen: false,
              ).fetchFavoriteWordsByCollectionId(collectionId: widget.collectionModel.id),
                      ...
                      Expanded(
                        ...
                        child: CardSwiper(
                          ...
                          cardBuilder: (context, index, percentThresholdX, percentThresholdY) {
                            return Provider.of<CardModeState>(context).cardMode
